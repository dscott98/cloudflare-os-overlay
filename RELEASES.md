...
| --- | --- | --- | --- |
| `0.1.0-candidate.3` | `8b9fd811d016b58ac5cbe1c28761f1d13dfe7138` | candidate | Rebased the deployment AI Gateway custom-model patch onto upstream AI binding transport; includes 18 upstream commits. |
